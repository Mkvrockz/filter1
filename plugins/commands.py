...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('🔍 Gʀᴏᴜᴘ', url="https://t.me/+u4j4wBac9KkzZDQ1"),
                    InlineKeyboardButton('🎬 channel', url='https://t.me/mwphub')
                ],[
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                ...
                                #InlineKeyboardButton('Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ', url=f'https://t.me/MOVIE_LOVERZZ')
                            ],[
    ...
    if not files_:
        ...
        try:
            ...
            title = '@movie_file_20  ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), file.file_name.split()))
