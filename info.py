...
API_ID = int(environ.get('API_ID', '25742491'))
API_HASH = environ.get('API_HASH', 'd569995393cc87706a2167f994505149')
...
PICS_JOIN = (environ.get('PICS_JOIN', '')).split()
# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5672857559').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001654996929').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mwphub69:mwpnetwork4@cluster0.pr9qkhi.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+u4j4wBac9KkzZDQ1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/mwphub')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/MovsU2')
